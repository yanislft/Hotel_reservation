<div class="w3-row">
    ...
    <div class="w3-center">
        <button onclick="document.getElementById('form01').style.display='block'" class="w3-button w3-theme" style="margin-left: 1%; margin-top: 1%; margin-bottom: 1%">Réservation</button>
    </div>

    <div id="form01" class="w3-col w3-modal" style="padding: 3%">
        <div class="w3-modal-content">
            ...
            <form action="verif.php" method="get" class="w3-card-2"> 
                ...
                <div class="w3-center">
                    <input action="form_verif.php" class="w3-theme w3-button w3-round-xlarge w3-hover-white" type="submit" value="Soumettre" >
